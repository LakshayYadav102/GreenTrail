...
function MyReceivedFoodPage() {
  ...
  const fetchReceivedFood = async () => {
    ...
    try {
      ...
      const fixedReceived = (res.data.received || []).map((item) => ({
        ...item,
        displayCarbon:
          item.carbonSaved && item.carbonSaved > 0
            ? item.carbonSaved
  ...
  const confirmReceipt = async () => {
    if (!receiverImage) {
      alert(
        "Please upload a photo of the received food to complete the handshake."
      );
      return;
    }
    ...
    try {
      ...
      await api.post(
        `/food-waste/confirm/${selectedDonationId}`,
        formData,
        {
          headers: {
      ...
      alert(
        "Donation verified! ICTs have been released to the donor."
      );
    ...
    <div className="fw-rec-page-wrapper">
      ...
      <div className={`fw-rec-container ${isLoaded ? "loaded" : ""}`}>
        ...
        <div className="fw-rec-header">
          ...
          <h1>
            My Received{" "}
            <span className="fw-gradient-text-pink">Food</span>
          </h1>

          <p className="fw-subtitle">
            Track the donations you've accepted and see your
            ...
            {summary && (
              <div className="fw-summary-grid">
                ...
                <div className="fw-summary-card eco">
                  ...
                  <h3>
                    {summary.totalCarbonImpact}{" "}
                    <span className="fw-unit">kg CO₂</span>
                  </h3>
                    ...
                    <div className="fw-card-inner">
                      ...
                      <div className="fw-card-header">
                        ...
                        <div className="fw-category-badge">
                          <span className="fw-cat-icon">
                            {getCategoryIcon(item.foodCategory)}
                          </span>

                          {item.foodCategory?.toUpperCase() ||
                            "UNKNOWN"}
                        </div>

                        {item.donationSource === "EVENT" && (
                          <span className="fw-event-tag">
                            🎊 Event
                          </span>
                        )}
                      ...
                      <div className="fw-card-body">
                        ...
                        <div className="fw-detail-row main-detail">
                          ...
                          <div className="fw-quantity-box">
                            <span className="fw-qty-val">
                              {item.quantity}
                            </span>

                            <span className="fw-qty-unit">
                              {item.unit}
                            </span>
                          </div>
                        ...
                        <div className="fw-detail-list">
                          ...
                          <div className="fw-list-item eco-impact">
                            ...
                            <div className="fw-list-text">
                              ...
                              <span className="fw-value highlight">
                                {item.displayCarbon} kg CO₂
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="fw-card-footer">
                        ...
                        <button
                          className="fw-btn fw-primary-btn"
                          onClick={() => {
                            setSelectedDonationId(item._id);
        ...
        <div className="fw-eco-footer">
          ...
          <div className="fw-footer-text">
            ...
            <p>
              Every accepted donation directly reduces food
              waste, lowers greenhouse gas emissions, and
      ...
      {showReceiptModal && (
        <div className="fw-modal-overlay">
          ...
          <div className="fw-modal-box">

            <h2>📦 Confirm Food Receipt</h2>

            <p className="fw-modal-text">
              Upload a photo of the received food package or
              meal to verify successful delivery and release
              ICT rewards.
            </p>
